...
<div id="wrapper">
    ...
    <div class='mp'>
        ...
        <p><a href="http://github.com/visionmedia/expresso">Expresso</a> is a JavaScript <a
                ...
                href="http://nodejs.org">nodejs</a>. Expresso is extremely fast, and is packed with features such as
            additional assertion methods, code coverage reporting, CI support, and more.</p>
        ...
        <ul>
            ...
            <li>test coverage support and reporting via <a href="http://github.com/visionmedia/node-jscoverage">node-jscoverage</a>
            </li>
...
<pre><code>assert.includes([1,2,3], 3);
    ...
    assert.includes('foobar', 'bar');
        ...
        <ul>
            ...
            <li><em>header</em> assert that all given headers match (unspecified are ignored, use a regexp or string)
            </li>
        </ul>
...
<pre><code>$ expresso --include lib test/*
        ...
        <p>The previous example is typically what I would recommend, since expresso
            supports test coverage via <a href="http://github.com/visionmedia/node-jscoverage">node-jscoverage</a>
            (bundled with expresso),
