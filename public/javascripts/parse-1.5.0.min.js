!function (a) {
    a.Parse = a.Parse || {}, a.Parse.VERSION = "js1.5.0"
}(this), function () {
    ...
    b.serverURL = "https://api.parse.com", "undefined" != typeof process && process.versions && process.versions.node && (b._isNode = !0), b.initialize = function (a, c, d) {
        ...
        return i._ClientVersion = b.VERSION, b._getInstallationId().then(function (a) {
            return i._InstallationId = a, h ? b.Promise.as({_sessionToken: h}) : b.User._canUseCurrentUser() ? b.User._currentAsync() : b.Promise.as(null)
        }).then(function (a) {
        ...
        if (e.isDate(a)) {
            ...
            return {__type: "Date", iso: a.toJSON()}
        }
    ...
    b.File = function (a, d, g) {
        ...
        h && (h = h[1].toLowerCase());
        var i = g || "";
        if (c.isArray(d))this._source = b.Promise.as(e(d), i); else if (d && d.base64) {
            var j = /^data:([a-zA-Z]*\/[a-zA-Z+.-]*);(charset=[a-zA-Z0-9\-\/\s]*,)?base64,(\S+)/, k = j.exec(d.base64);
            k && k.length > 0 ? this._source = b.Promise.as(4 === k.length ? k[3] : k[2], k[1]) : this._source = b.Promise.as(d.base64, i)
        } else if ("undefined" != typeof File && d instanceof File)this._source = f(d, g); else if (c.isString(d))throw"Creating a Parse.File from a String is not yet supported."
    }, b.File.prototype = {
        name: function () {
            return this._name
        }, url: function () {
    ...
    b.Object = function (a, d) {
        ...
        _existed: !1, initialize: function () {
            ...
            return b._objectEach(d, function (c, e) {
                ...
                d[b] = a
            }), c.has(this, "id") && (d.objectId = this.id), c.has(this, "createdAt") && (c.isDate(this.createdAt) ? d.createdAt = this.createdAt.toJSON() : d.createdAt = this.createdAt), c.has(this, "updatedAt") && (c.isDate(this.updatedAt) ? d.updatedAt = this.updatedAt.toJSON() : d.updatedAt = this.updatedAt), d.__type = "Object", d.className = this.className, d
    ...
    b.Collection = function (a, b) {
        ...
        model: b.Object, initialize: function () {
            ...
            return e.find({useMasterKey: a.useMasterKey, sessionToken: a.sessionToken}).then(function (b) {
    ...
    b.User = b.Object.extend("_User", {
        _isCurrentUser: !1, _mergeFromObject: function (a) {
            ...
            return h.success = function (a) {
                a._handleSaveResult(b.User._canUseCurrentUser()), d.success && d.success.apply(this, arguments)
            }, this.save(a, h)
        }, logIn: function (a) {
        ...
        enableRevocableSession: function (a) {
            return a = a || {}, b.User._isRevocableSessionEnabled = !0, b.User._canUseCurrentUser() && b.User.current() ? b.User.current()._upgradeToRevocableSession(a) : b.Promise.as()._thenRunCallbacks(a)
        },
    ...
    b.Query = function (a) {
        ...
        get: function (a, d) {
            ...
            var f = {};
            return d && c.has(d, "useMasterKey") && (f = {useMasterKey: d.useMasterKey}), d && c.has(d, "sessionToken") && (f.sessionToken = d.sessionToken), e.first(f).then(function (a) {
                if (a)return a;
            ...
            var g = {};
            c.has(d, "useMasterKey") && (g.useMasterKey = d.useMasterKey), c.has(d, "sessionToken") && (g.sessionToken = d.sessionToken);
            var h = !1;
            return b.Promise._continueWhile(function () {
                return !h
            }, function () {
